                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::NullValue => {
                            ...
                            constant_kind__ = map_.next_value::<::std::option::Option<::pbjson_types::NullValue>>()?.map(|x| constant::ConstantKind::NullValue(x as i32));
                        }
...
;
                        ...
                        GeneratedField::Null => {
                            ...
                            type_kind__ = map_.next_value::<::std::option::Option<::pbjson_types::NullValue>>()?.map(|x| r#type::TypeKind::Null(x as i32));
                        }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::NullValue => {
                            ...
                            kind__ = map_.next_value::<::std::option::Option<::pbjson_types::NullValue>>()?.map(|x| value::Kind::NullValue(x as i32));
                        }
                        GeneratedField::BoolValue => {
                            if kind__.is_some() {
                                return Err(serde::de::Error::duplicate_field("boolValue"));
