        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/sapphillon.ai.v1.ModelService/CreateModel",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sapphillon.ai.v1.ModelService", "CreateModel"));
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sapphillon.ai.v1.ModelService/GetModel",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sapphillon.ai.v1.ModelService", "GetModel"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sapphillon.ai.v1.ModelService/ListModels",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sapphillon.ai.v1.ModelService", "ListModels"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sapphillon.ai.v1.ModelService/UpdateModel",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sapphillon.ai.v1.ModelService", "UpdateModel"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sapphillon.ai.v1.ModelService/DeleteModel",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sapphillon.ai.v1.ModelService", "DeleteModel"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod model_service_server {
    ...
    pub const SERVICE_NAME: &str = "sapphillon.ai.v1.ModelService";
...
pub mod provider_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sapphillon.ai.v1.ProviderService/CreateProvider",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sapphillon.ai.v1.ProviderService", "CreateProvider"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sapphillon.ai.v1.ProviderService/GetProvider",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sapphillon.ai.v1.ProviderService", "GetProvider"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sapphillon.ai.v1.ProviderService/ListProviders",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sapphillon.ai.v1.ProviderService", "ListProviders"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sapphillon.ai.v1.ProviderService/UpdateProvider",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sapphillon.ai.v1.ProviderService", "UpdateProvider"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sapphillon.ai.v1.ProviderService/DeleteProvider",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sapphillon.ai.v1.ProviderService", "DeleteProvider"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod provider_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sapphillon.ai.v1.ProviderService";
    impl<T> tonic::server::NamedService for ProviderServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod search_model_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct SearchModelServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl SearchModelServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> SearchModelServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> SearchModelServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            SearchModelServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn search_model(
            &mut self,
            request: impl tonic::IntoRequest<super::SearchModelRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SearchModelResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sapphillon.ai.v1.SearchModelService/SearchModel",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sapphillon.ai.v1.SearchModelService", "SearchModel"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
/// Generated server implementations.
pub mod search_model_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with SearchModelServiceServer.
    #[async_trait]
    pub trait SearchModelService: std::marker::Send + std::marker::Sync + 'static {
        async fn search_model(
            &self,
            request: tonic::Request<super::SearchModelRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SearchModelResponse>,
            tonic::Status,
        >;
    ...
    #[derive(Debug)]
    pub struct SearchModelServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> SearchModelServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for SearchModelServiceServer<T>
    where
        T: SearchModelService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::Body>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sapphillon.ai.v1.SearchModelService/SearchModel" => {
                    #[allow(non_camel_case_types)]
                    struct SearchModelSvc<T: SearchModelService>(pub Arc<T>);
                    impl<
                        T: SearchModelService,
                    > tonic::server::UnaryService<super::SearchModelRequest>
                    for SearchModelSvc<T> {
                        type Response = super::SearchModelResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SearchModelService>::search_model(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SearchModelSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for SearchModelServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sapphillon.ai.v1.SearchModelService";
    impl<T> tonic::server::NamedService for SearchModelServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
