...
pub mod model_service_server {
    ...
    impl<T: ModelService> tonic::server::NamedService for ModelServiceServer<T> {
        const NAME: &'static str = "sapphillon.ai.v1.ModelService";
    }
}
/// Generated client implementations.
...
pub mod provider_service_server {
    ...
    #[derive(Debug)]
    pub struct ProviderServiceServer<T: ProviderService> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: ProviderService> ProviderServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T: ProviderService> Clone for ProviderServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: ProviderService> tonic::server::NamedService for ProviderServiceServer<T> {
        const NAME: &'static str = "sapphillon.ai.v1.ProviderService";
    }
}
/// Generated client implementations.
...
pub mod search_model_service_server {
    ...
    #[async_trait]
    pub trait SearchModelService: Send + Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct SearchModelServiceServer<T: SearchModelService> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: SearchModelService> SearchModelServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T: SearchModelService> Clone for SearchModelServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: SearchModelService> tonic::server::NamedService
    for SearchModelServiceServer<T> {
        const NAME: &'static str = "sapphillon.ai.v1.SearchModelService";
    }
}
